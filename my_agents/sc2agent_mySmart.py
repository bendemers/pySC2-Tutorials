...
_BUILD_GAS = actions.FUNCTIONS.Build_Refinery_screen.id
...
ACTION_BUILD_GAS = 'buildrefinery'
    ...
    def step(self, obs):
        ...
        if smart_action == ACTION_DO_NOTHING:
            ...
            if unit_y.any():
                ...
                return actions.FunctionCall(_SELECT_POINT, [_NOT_QUEUED, target])
        elif smart_action == ACTION_BUILD_GAS:
            if _BUILD_GAS in obs.observation['available_actions']:
                unit_type = obs.observation['screen'][_UNIT_TYPE]
                unit_y, unit_x = (unit_type == _TERRAN_COMMANDCENTER).nonzero()
                ...
                if unit_y.any():
                    ...
                    return actions.FunctionCall(_BUILD_GAS, [_NOT_QUEUED, target])
